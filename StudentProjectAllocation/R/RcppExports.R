...
hungarian_algorithm_cpp <- function(cost) {
    .Call(`_StudentProjectAllocation_hungarian_algorithm_cpp`, cost)
}

genetic_algorithm_cpp <- function(cost, population_size = 100L, generations = 500L, mutation_rate = 0.05) {
    .Call(`_StudentProjectAllocation_genetic_algorithm_cpp`, cost, population_size, generations, mutation_rate)
}
...
insertion_sort_Rcpp <- function(v) {
    .Call(`_StudentProjectAllocation_insertion_sort_Rcpp`, v)
}
...
heap_sort_Rcpp <- function(v) {
    .Call(`_StudentProjectAllocation_heap_sort_Rcpp`, v)
}
